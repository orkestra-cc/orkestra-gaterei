...
- Sales reports list + detail (`/sales/reports/*`) and skills list (`/sales/skills/`) — entirely IT-literal; not previously listed but needed for full sales i18n coverage
