...
[![Backend CI](https://img.shields.io/github/actions/workflow/status/orkestra-cc/orkestra/backend.yml?branch=dev&label=backend&logo=github&style=for-the-badge)](https://github.com/orkestra-cc/orkestra/actions/workflows/backend.yml)
[![Frontend Admin CI](https://img.shields.io/github/actions/workflow/status/orkestra-cc/orkestra/frontend-admin.yml?branch=dev&label=frontend-admin&logo=github&style=for-the-badge)](https://github.com/orkestra-cc/orkestra/actions/workflows/frontend-admin.yml)
[![Mobile CI](https://img.shields.io/github/actions/workflow/status/orkestra-cc/orkestra/mobile.yml?branch=dev&label=mobile&logo=github&style=for-the-badge)](https://github.com/orkestra-cc/orkestra/actions/workflows/mobile.yml)
[![Security](https://img.shields.io/github/actions/workflow/status/orkestra-cc/orkestra/security.yml?branch=dev&label=security&logo=github&style=for-the-badge)](https://github.com/orkestra-cc/orkestra/actions/workflows/security.yml)
