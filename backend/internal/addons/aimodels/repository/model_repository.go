...
// ModelRepository defines CRUD operations for AI model configurations
type ModelRepository interface {
	...
	List(ctx context.Context, modelType, provider, category string) ([]models.ModelConfig, error)
...
func (r *modelRepository) List(ctx context.Context, modelType, provider, category string) ([]models.ModelConfig, error) {
	filter := bson.M{}
	if modelType != "" {
	...
	if category != "" {
		filter["providerCategory"] = category
	}
