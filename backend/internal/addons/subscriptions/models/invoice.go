...
//
// Inherits the polymorphic owner from its subscription so cross-owner
// listings (admin aggregator, "all my invoices" personal view) can be
// served without joining back through subscriptions_subscriptions.
