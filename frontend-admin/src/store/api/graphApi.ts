...
export const graphApi = baseApi.injectEndpoints({
  endpoints: builder => ({
    ...
    browseRelationships: builder.query<
      QueryResult,
      BrowseRelationshipsParams | void
    >({
      query: params => {
        const qs = params ? buildQueryParams(params) : '';
    ...
    listVectorIndexes: builder.query<
      { indexes: VectorIndex[] },
    ...
    createVectorIndex: builder.mutation<
      { message: string },
      CreateVectorIndexRequest
    >({
      query: body => ({
    ...
    dropVectorIndex: builder.mutation<
      { message: string },
    ...
    deleteRelationship: builder.mutation<
      DeleteRelationshipResponse,
      { relationshipId: number; database?: string }
    >({
